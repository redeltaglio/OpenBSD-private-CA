...
#
#   $ ./configure --with-rt-group=bin --with-libs-group=bin --enable-layout=OpenBSD --enable-gpg --enable-graphviz --enable-gd --prefix=/usr/local --sysconfdir=/etc --mandir=/usr/local/man --infodir=/usr/local/info --localstatedir=/var --disable-silent-rules --disable-gtk-doc
#
...
Set( %SMIME,
    Enable => 0,
    OpenSSL => 'openssl',
    Keyring => q{/var/www/rt/data/smime},
    CAPath => undef,
